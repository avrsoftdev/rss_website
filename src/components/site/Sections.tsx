...
/* ---------- Testimonials ---------- */
const tests = [
  { name: "Rahul Mehta", role: "Plant Head, JSW Steel", quote: "RSS automated our rolling line in 18 days — uptime jumped to 99.2%." },
  { name: "Priya Iyer", role: "GM, Adani Energy", quote: "Their SCADA NOC gives us total visibility across 40 distributed sites." },
  { name: "Arjun Patel", role: "CTO, GreenGrid Co.", quote: "From design to commissioning, delivery was flawless. Truly enterprise-grade." },
];
