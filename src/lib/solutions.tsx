...
export const solutions = [
  ...
  },
  {
    ...
    highlights: [
      "PLC, HMI, VFD, servo, and motion control integration",
      "Machine automation, line automation, and process control",
      "Panel wiring, instrumentation, field devices, and commissioning",
      "Operator-friendly dashboards, alarms, recipes, and reporting",
    ],
  ...
  },
  {
    ...
    highlights: [
      "SCADA architecture, tag mapping, historian setup, and alarm design",
      "Remote monitoring for distributed assets and multi-site operations",
      "Secure network layouts, user roles, reports, and event logging",
      "Integration with PLCs, meters, sensors, gateways, and cloud systems",
    ],
